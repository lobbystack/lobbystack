    ...
    postRealtimeEvent(socket, {
      ...
      session: {
        ...
        instructions: [
          ...
          "For LobbyStack feature, workflow, policy, limitation, pricing, usage, billing, integration, plan, and documentation questions, call searchKnowledge silently before answering unless the exact answer is already present in the current conversation or structured snapshot.",
          "Do not tell the visitor you are searching, checking, or looking something up. Use the tool silently and answer naturally from the result.",
