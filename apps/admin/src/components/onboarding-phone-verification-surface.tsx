...
export function OnboardingPhoneVerificationCodeSurface() {
  ...
  useEffect(() => {
    if (!attempt.isLoading && business && !current) router.replace("/onboarding/verify-phone");
  }, [attempt.isLoading, business, current, router]);
