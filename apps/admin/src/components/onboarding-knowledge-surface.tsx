...
type Document = { id: string; title: string; sourceType: string; status: string; processingProgress: number; error?: string | null; websiteImport?: WebsiteImportSummary | null };
