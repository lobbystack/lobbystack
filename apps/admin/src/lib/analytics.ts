...
const DEPLOYMENT_MODE = process.env.NEXT_PUBLIC_DEPLOYMENT_MODE ?? "development";
...
const POSTHOG_HOST = resolvePostHogHost(process.env.NEXT_PUBLIC_POSTHOG_HOST);
const POSTHOG_UI_HOST = process.env.NEXT_PUBLIC_POSTHOG_UI_HOST ?? "https://us.posthog.com";
...
export function captureAnalyticsEvent(
  ...
  if (!validation.ok && process.env.NODE_ENV === "development") {
    console.warn(
