...
export const en = {
  common: {
    ...
    noCreditCardCancelAnytime: "No credit card required. Cancel anytime.",
    ...
    seeFullFeatureList: "See the full feature list",
  },
  routes: {
    "/": {
    ...
    "/changelog/": {
      title: "LobbyStack Changelog | Product Updates",
      description:
    ...
    "/404/": {
      ...
      description:
        "The LobbyStack page you requested could not be found. Search or return to the homepage.",
    },
  },
