...
const featuresHeroCopy = {
  en: {
    ...
    body:
      "LobbyStack handles AI phone answering, appointment booking, team follow-up, call routing, quotes, and lead qualification without phone trees or workflow-builder mess.",
  ...
  fr: {
    h1Start: "Des fonctionnalites de receptionniste IA qui",
    h1Emphasis: "font avancer le travail",
    body:
      "LobbyStack gere la reponse telephonique IA, la prise de rendez-vous, le suivi d'equipe, le routage, les devis et la qualification sans arbre telephonique ni constructeur de flux fragile.",
    workflowLabel: "Ecrivez le flux",
    workflowText:
      "Quand quelqu'un demande un devis, demandez le service, la localisation, le delai et le budget. Donnez la fourchette approuvee pour les travaux standards. Si un prix exact est necessaire, planifiez un rappel avec l'equipe commerciale et joignez le resume.",
    callLabel: "LobbyStack gere l'appel",
    quoteTitle: "Demande de devis de Sarah M.",
    service: "Service : estimation de renovation",
    budget: "Budget : 8 000 $ a 12 000 $",
    timeline: "Delai : le mois prochain",
    priceRange: "Fourchette partagee",
    callbackNeeded: "Rappel necessaire",
    outcomeLabel: "Revoyez le resultat",
    callbackBooked: "Rappel reserve",
    callbackTime: "Mardi a 14 h",
    assigned: "Assigne a Alex",
    confirmation: "Confirmation client envoyee",
    notification: "Notification equipe envoyee",
    summary: "Resume joint",
  },
