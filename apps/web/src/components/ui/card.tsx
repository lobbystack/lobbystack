...
function Card({
  ...
  return (
    <div
      ...
      className={cn(
        surfaceClassName,
        "group/card flex flex-col gap-6 py-6 text-sm text-card-foreground has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        className
      )}
      {...props}
    />
