...
For the reliability release, follow [Roll out the reliability fixes](./remediation-rollout.md). That runbook covers current role checks, OAuth compatibility, restricted widget issuance, and retention approval gates.
