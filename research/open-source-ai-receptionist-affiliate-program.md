...
- Core product promise: answers phone calls, manages SMS and website chat, books appointments, handles appointment changes, and transfers calls to a person.
...
| --- | --- | --- | --- | --- | --- | --- |
| Upfirst | AI receptionist | 25% lifetime commission plus $50 bonus after customer has been active for 2 months | Paid via Stripe; no public minimum found on page | Commission starts 30 days after signup; cookie window not found | Strong affiliate focus: referral portal, pending commissions, and "get paid for referring clients" messaging | [Upfirst Affiliate Partner Program](https://upfirst.ai/affiliate-program), accessed July 7, 2026 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Cal.com | Open-source scheduling SaaS | 20% commission for 12 months | Not found in inspected page | Not found in inspected page | Strong closest analogue to LobbyStack's rate and duration; referred clients also get 20% off for 12 months. | [Cal.com Affiliate Program](https://cal.com/affiliate-program), accessed July 7, 2026; [Cal.com Affiliate Terms](https://cal.com/affiliate-terms), accessed July 7, 2026 |
...
| Supabase | Open-source backend platform | No published affiliate rate found in inspected source | Not found | Not found | Public page emphasizes partner ecosystem rather than direct affiliate payouts. Good contrast: many open-source companies choose partner/solution ecosystems over public affiliate pages. | [Supabase Partners](https://supabase.com/partners), accessed July 7, 2026 |
...
- Versus **Upfirst**: Upfirst is affiliate-friendly with 25% lifetime plus $50 bonus. LobbyStack should avoid a pure rate war and instead target affiliates who care about open-source, agencies, developers, and client-specific deployment options.
...
3. **Value proposition for affiliates**
   - More than a commission link: a credible technical product that agencies can explain and, when needed, deploy more deeply.
...
5. **Potential improvement to publish before/during blog**
   ...
   - Consider a referral discount. Cal.com's "affiliate earns 20%, referral saves 20%" is clean and straightforward to promote.
...
- [Supabase Partners](https://supabase.com/partners), accessed July 7, 2026. No visible publication date found. Key note: partner ecosystem page found; no published affiliate commission rate found in inspected source.
