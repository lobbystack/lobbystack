...
Start with the setup guide if you are setting up LobbyStack for the first time. If your workspace is already live, use the dashboard guides to review activity, tune your agent, and keep follow-ups moving.

<Tip>
  Start with a free account and use a dashboard test call before claiming a public number.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Connect your tools" icon="plug" href="/integrations/overview">
    Connect Google Calendar and review SMS consent requirements.
  </Card>
</CardGroup>
...
| --- | --- | --- |
| **General** | Home, Calls, Messages, Contacts, Appointments | Review daily activity, conversations, caller profiles, and bookings. |
