...
| `DASHBOARD_TEST_CALL_TOKEN` | Optional Convex token for elevated dashboard test-call limits from verified internal paths; localhost smoke tests do not require it. |
