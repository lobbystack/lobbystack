...
description: "Run LobbyStack on one server with Docker Compose. You'll configure PostgreSQL, Redis, file storage, and HTTPS, then verify the deployment before going live."
...
- at least 2 vCPU, 4 GB of RAM, and durable disk storage
