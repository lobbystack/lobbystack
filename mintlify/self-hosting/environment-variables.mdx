...
| `DASHBOARD_TEST_CALL_TOKEN` | Convex | Optional token for elevated dashboard test-call rate limits from verified internal paths. Do not expose this through public widget requests. |
