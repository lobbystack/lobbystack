---
title: "Write receptionist rules"
...
Good rules are specific and action-oriented:
...
<Note>
  Rules let you define agent behavior in clear language. Keep each rule updated as your process changes.
</Note>
