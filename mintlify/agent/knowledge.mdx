...
The **Knowledge** page is where you add information the receptionist can use when answering callers. Use it for facts that should be straightforward to retrieve: hours, location, parking, pricing notes, service descriptions, policies, intake requirements, and FAQs.
