...
The **Agent** section controls how your AI receptionist behaves. It is split into AI settings, Knowledge, Services, Appointment changes, and Rules.
...
<CardGroup cols={2}>
  ...
  <Card title="Appointment changes" icon="calendar-clock" href="/agent/appointment-changes">
    Let the AI receptionist cancel and reschedule appointments automatically after confirmation.
  </Card>
