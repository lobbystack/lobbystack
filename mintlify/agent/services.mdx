...
Google Calendar is the supported customer-facing calendar integration today. When calendar booking is configured, LobbyStack can use connected calendar data to help with appointment requests.
