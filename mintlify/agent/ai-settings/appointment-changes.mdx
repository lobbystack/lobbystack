---
title: "Configure appointment changes"
description: "Let your AI receptionist cancel and reschedule appointments during calls with configurable verification."
sidebarTitle: "Appointment changes"
contentType: "How-to"
---

When callers need to cancel or move an appointment, LobbyStack can handle the request during the call.
...
- Complete the request during the call.
...
- The phone number from the call.
- The customer's name.
