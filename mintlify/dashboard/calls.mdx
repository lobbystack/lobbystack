---
title: "Review calls and follow-up work"
...
![LobbyStack Calls page](/images/screenshots/calls.png)

_The Calls page lets operators review the call list, open details, and follow up from one place._
