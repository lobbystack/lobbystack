...
<Steps>
  ...
  <Step title="Claim a phone number">
    Review the suggested business number or click **Pick a different number** to search by city, area code, or toll-free number.

    Click **Continue** to claim the selected number for your business. Calls to that number are routed to your AI receptionist.
  </Step>
