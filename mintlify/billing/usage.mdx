---
title: "Track usage and limits"
description: "Track voice minutes, alert SMS segments, outbound call attempts, knowledge storage, and paid-plan overages."
...
| Metric | Meaning |
| --- | --- |
| Voice minutes | Time spent on live voice calls. Calls under 10 seconds and calls the receptionist ends as spam are excluded. |
