...
Transfers use the default transfer number in **Receptionist** > **AI settings**. When a live handoff is not the right next step, the receptionist can create a follow-up task with callback details. Those tasks appear in the dashboard and on call detail pages.
...
Use rules for call-handling behavior. Manage recording and retention policy in your deployment and compliance settings.
